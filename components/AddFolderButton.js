...
var AddFolderButton = function (_Component) {
  ...
  function AddFolderButton(props) {
    ...
    var _this = _possibleConstructorReturn(this, (AddFolderButton.__proto__ || Object.getPrototypeOf(AddFolderButton)).call(this, props));
  ...
  _createClass(AddFolderButton, [{
    ...
    key: 'addToNewFolder',
    value: function addToNewFolder(newFolder) {
      var newButton = createFolderButton(newFolder.value);
      newFolder.value = '';
